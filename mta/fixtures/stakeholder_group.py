...
def stakeholder_group(create_api, get_api, delete_api):
    ...
    new_stakeholder_group = create_api.stakeholdergroups_post(api_stakeholder_group.to_dict())
    yield new_stakeholder_group
    delete_api.stakeholdergroups_id_delete(str(new_stakeholder_group.id))
