...
def test_business_service_crud(business_service, stakeholder, businessservices_api):
    ...
    business_service_from_db = businessservices_api.businessservices_id_get(business_service.id)
    ...
    businessservices_api.businessservices_id_put(business_service.id, business_service.to_dict())
    update_business_service_from_db = businessservices_api.businessservices_id_get(business_service.id)
