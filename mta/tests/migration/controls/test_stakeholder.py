...
def test_stakeholder_crud(stakeholder, stakeholders_api):
    ...
    stakeholder_from_db = stakeholders_api.stakeholders_id_get(str(stakeholder.id))
    ...
    stakeholders_api.stakeholders_id_put(id=str(stakeholder.id), stakeholder=stakeholder)
    update_stakeholder_from_db = stakeholders_api.stakeholders_id_get(str(stakeholder.id))
