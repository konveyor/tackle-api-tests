...
def test_job_function_crud(job_function, jobfunctions_api):
    ...
    job_function_from_db = jobfunctions_api.jobfunctions_id_get(str(job_function.id))
    ...
    jobfunctions_api.jobfunctions_id_put(id=str(job_function.id), job_function=job_function)
    updated_job_function_from_db = jobfunctions_api.jobfunctions_id_get(str(job_function.id))
