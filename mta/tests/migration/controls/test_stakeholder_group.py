...
def test_stakeholder_group_crud(stakeholder_group, stakeholdergroups_api):
    ...
    stakeholder_group_from_db = stakeholdergroups_api.stakeholdergroups_id_get(stakeholder_group.id)
    ...
    stakeholdergroups_api.stakeholdergroups_id_put(stakeholder_group.id, stakeholder_group.to_dict())
    updated_stakeholder_group_from_db = stakeholdergroups_api.stakeholdergroups_id_get(stakeholder_group.id)
