...
class ApiTracker(object):
    ...
    def __init__(self, connected=None, create_time=None, create_user=None, id=None, identity=None, kind=None, last_updated=None, message=None, metadata=None, name=None, update_user=None, url=None, _configuration=None):  # noqa: E501
