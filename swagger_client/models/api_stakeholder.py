...
class ApiStakeholder(object):
    ...
    swagger_types = {
        ...
        'contributes': 'list[ApiRef]',
        'create_time': 'str',
        'create_user': 'str',
        'email': 'str',
        'id': 'int',
        'job_function': 'ApiRef',
        'migration_waves': 'list[ApiRef]',
        'name': 'str',
        'owns': 'list[ApiRef]',
    ...
    def __init__(self, business_services=None, contributes=None, create_time=None, create_user=None, email=None, id=None, job_function=None, migration_waves=None, name=None, owns=None, stakeholder_groups=None, update_user=None, _configuration=None):  # noqa: E501
        ...
        self._contributes = None
        self._create_time = None
        self._create_user = None
        self._email = None
        self._id = None
        self._job_function = None
        self._migration_waves = None
        self._name = None
        self._owns = None
        ...
        if migration_waves is not None:
            self.migration_waves = migration_waves
        self.name = name
        if owns is not None:
            self.owns = owns
    ...
    def contributes(self):
        """Gets the contributes of this ApiStakeholder.  # noqa: E501


        :return: The contributes of this ApiStakeholder.  # noqa: E501
        :rtype: list[ApiRef]
        """
        return self._contributes

    @contributes.setter
    def contributes(self, contributes):
        """Sets the contributes of this ApiStakeholder.


        :param contributes: The contributes of this ApiStakeholder.  # noqa: E501
        :type: list[ApiRef]
        """
    ...
    def migration_waves(self):
        """Gets the migration_waves of this ApiStakeholder.  # noqa: E501


        :return: The migration_waves of this ApiStakeholder.  # noqa: E501
        :rtype: list[ApiRef]
        """
        return self._migration_waves

    @migration_waves.setter
    def migration_waves(self, migration_waves):
        """Sets the migration_waves of this ApiStakeholder.


        :param migration_waves: The migration_waves of this ApiStakeholder.  # noqa: E501
        :type: list[ApiRef]
        """

        self._migration_waves = migration_waves
    ...
    @property
    def owns(self):
        """Gets the owns of this ApiStakeholder.  # noqa: E501


        :return: The owns of this ApiStakeholder.  # noqa: E501
        :rtype: list[ApiRef]
        """
        return self._owns
    ...
    @owns.setter
    def owns(self, owns):
        """Sets the owns of this ApiStakeholder.


        :param owns: The owns of this ApiStakeholder.  # noqa: E501
        :type: list[ApiRef]
        """
