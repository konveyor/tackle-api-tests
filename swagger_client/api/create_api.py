...
class CreateApi(object):
    ...
    def applications_id_facts_key_post(self, id, key, fact, **kwargs):  # noqa: E501
        """Create a fact.  # noqa: E501

        Create a fact.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.applications_id_facts_key_post(id, key, fact, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.applications_id_facts_key_post_with_http_info(id, key, fact, **kwargs)  # noqa: E501
        else:
            (data) = self.applications_id_facts_key_post_with_http_info(id, key, fact, **kwargs)  # noqa: E501
            return data

    def applications_id_facts_key_post_with_http_info(self, id, key, fact, **kwargs):  # noqa: E501
        """Create a fact.  # noqa: E501

        Create a fact.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.applications_id_facts_key_post_with_http_info(id, key, fact, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method applications_id_facts_key_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('id' not in params or
            ...
            raise ValueError("Missing the required parameter `id` when calling `applications_id_facts_key_post`")  # noqa: E501
        # verify the required parameter 'key' is set
        if self.api_client.client_side_validation and ('key' not in params or
                                                       params['key'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `key` when calling `applications_id_facts_key_post`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('fact' not in params or
            ...
            raise ValueError("Missing the required parameter `fact` when calling `applications_id_facts_key_post`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/applications/{id}/facts/{key}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def rulebundles_post(self, rule_bundle, **kwargs):  # noqa: E501
        """Create a bundle.  # noqa: E501

        Create a bundle.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rulebundles_post(rule_bundle, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ApiRuleBundle rule_bundle: RuleBundle data (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.rulebundles_post_with_http_info(rule_bundle, **kwargs)  # noqa: E501
        else:
            (data) = self.rulebundles_post_with_http_info(rule_bundle, **kwargs)  # noqa: E501
            return data

    def rulebundles_post_with_http_info(self, rule_bundle, **kwargs):  # noqa: E501
        """Create a bundle.  # noqa: E501

        Create a bundle.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rulebundles_post_with_http_info(rule_bundle, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method rulebundles_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('rule_bundle' not in params or
            ...
            raise ValueError("Missing the required parameter `rule_bundle` when calling `rulebundles_post`")  # noqa: E501
    ...
    def settings_key_post(self, setting, **kwargs):  # noqa: E501
        """Create a setting.  # noqa: E501

        Create a setting.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.settings_key_post(setting, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ApiSetting setting: Setting value (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.settings_key_post_with_http_info(setting, **kwargs)  # noqa: E501
        else:
            (data) = self.settings_key_post_with_http_info(setting, **kwargs)  # noqa: E501
            return data

    def settings_key_post_with_http_info(self, setting, **kwargs):  # noqa: E501
        """Create a setting.  # noqa: E501

        Create a setting.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.settings_key_post_with_http_info(setting, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method settings_key_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('setting' not in params or
            ...
            raise ValueError("Missing the required parameter `setting` when calling `settings_key_post`")  # noqa: E501
    ...
    def tagcategories_post(self, tag_type, **kwargs):  # noqa: E501
        """Create a tag category.  # noqa: E501

        Create a tag category.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.tagcategories_post(tag_type, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ApiTagCategory tag_type: Tag Category data (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.tagcategories_post_with_http_info(tag_type, **kwargs)  # noqa: E501
        else:
            (data) = self.tagcategories_post_with_http_info(tag_type, **kwargs)  # noqa: E501
            return data

    def tagcategories_post_with_http_info(self, tag_type, **kwargs):  # noqa: E501
        """Create a tag category.  # noqa: E501

        Create a tag category.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.tagcategories_post_with_http_info(tag_type, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method tagcategories_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('tag_type' not in params or
            ...
            raise ValueError("Missing the required parameter `tag_type` when calling `tagcategories_post`")  # noqa: E501
