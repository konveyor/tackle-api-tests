...
class UpdateApi(object):
    ...
    def rulebundles_id_put(self, id, rule_bundle, **kwargs):  # noqa: E501
        """Update a bundle.  # noqa: E501

        Update a bundle.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rulebundles_id_put(id, rule_bundle, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.rulebundles_id_put_with_http_info(id, rule_bundle, **kwargs)  # noqa: E501
        else:
            (data) = self.rulebundles_id_put_with_http_info(id, rule_bundle, **kwargs)  # noqa: E501
            return data

    def rulebundles_id_put_with_http_info(self, id, rule_bundle, **kwargs):  # noqa: E501
        """Update a bundle.  # noqa: E501

        Update a bundle.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rulebundles_id_put_with_http_info(id, rule_bundle, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method rulebundles_id_put" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in params or
                                                       params['id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `id` when calling `rulebundles_id_put`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('rule_bundle' not in params or
            ...
            raise ValueError("Missing the required parameter `rule_bundle` when calling `rulebundles_id_put`")  # noqa: E501
